...
public class PlayerControlle : MonoBehaviour
{
    ...
    //private ItemControlle currentItem; // Variable para almacenar el �tem actual
    //private bool hasItem = false; // Estado para verificar si el jugador tiene un �tem
    public bool crouch;
    void Start()
    {
    ...
    void Update()
    {
        ...
        MouseLook();
        Crouch();
        //// Detectar si se presiona la tecla E para recoger o soltar el �tem
        ...
        //            hasItem = true; // El jugador ahora tiene el �tem
        //        }
        //        else
        //        {
        //            currentItem.DropItem();
        //            hasItem = false; // El jugador ya no tiene el �tem
        //            currentItem = null; // Limpia la referencia al �tem
        //        }
        //    }
        //}
    ...
    //{
    //    // Verificar si el objeto con el que colisionamos es un �tem
    //    ItemControlle item = other.GetComponent<ItemControlle>();
    //    if (item != null)
    //    {
    //        currentItem = item; // Guardar el �tem actual
    //    }
    //}

    //private void OnTriggerExit(Collider other)
    //{
    //    // Limpiar la referencia cuando el jugador sale del �rea del �tem
